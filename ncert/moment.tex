...
\item Consider the probability distribution of a random variable $X$ given in 
        \tabref{tab:exemplar/12/13/3/24}.
Calculate
\begin{enumerate}
\item var$\brak{X}$
...
\item Find the variance of distribution
 in \tabref{exemplar/12/13/3/37/tables}
	\begin{table}[H]
		\centering
 \input{exemplar/12/13/3/37/tables/table.tex}
 \caption{}
 \label{exemplar/12/13/3/37/tables}
\end{table}
\solution
...
\item The probability distribution of a discrete random variable $X$ is given 
in \tabref{exemplar/12/13/3/50/table}.
\begin{table}[H]
    \centering
...
\end{tabular} 
\caption{}
\label{exemplar/12/13/3/50/table}
\end{table}
Calculate
\begin{enumerate}
...
\hline
$X$    & 0 & 1 & 2 & 3 \\ \hline
$P(X)$ & $\frac{1}{5}$ & $\frac{2}{5}$ & $\frac{1}{5}$ & $\frac{1}{5}$ \\ \hline
\end{tabular}
\end{minipage}
\hfill
\begin{minipage}{0.48\columnwidth}
...
\hline
$Y$    & 0 & 1 & 2 & 3 \\ \hline
$P(Y)$ & $\frac{1}{5}$ & $\frac{3}{10}$ & $\frac{2}{5}$ & $\frac{1}{10}$ \\ \hline
\end{tabular}
\end{minipage}
\end{table}
...
\item For the following probability distribution 
 in \tabref{tab:exemplar/12/13/3/26/tables},
	determine the standard deviation of the random variable $X$.
\begin{table}[H]
	\centering
 \input{exemplar/12/13/3/26/tables/table.tex}
 \caption{}
 \label{tab:exemplar/12/13/3/26/tables}
\end{table}
\solution 
...
\item A discrete random variable $X$ has the probability distribution given 
 in \tabref{tab:exemplar/12/13/3/10/}.
\begin{table}[H]
	\centering
\begin{tabular}{|c|c|c|c|c|}
\hline
...
\item Find the mean of $\bnm{4}{\frac{1}{3}}$.
