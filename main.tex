...
\input{axioms/defs.tex}
\subsection{Boolean Logic}
\input{axioms/axioms.tex}
\subsection{Applications}
\input{word/axioms.tex}
\subsection{Conditional Probability}
\input{axioms/cond.tex}
\subsection{Applications}
\input{word/cond.tex}
\subsection{Random Variables}
\input{axioms/rand.tex}
\iffalse
\subsection{Applications}
\input{exemplar/cond/word.tex}
\fi
