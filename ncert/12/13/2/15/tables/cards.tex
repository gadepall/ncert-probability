...
\ifthenelse{\isundefined{\gnumericColE}}{\newlength{\gnumericColE}}{}\settowidth{\gnumericColE}{\begin{tabular}{@{}p{63pt*\gnumericScale}@{}}x\end{tabular}}
...
%	\caption{}\label{tab:ncert/12/13/2/15}             \\	%
...
\hhline{|-|-|-|-|-~}
	...
	{\gnumericPB{\centering}\gnumbox{Item}}
	...
	{\gnumericPB{\centering}\gnumbox{Independent}}
	&
\\
\hhline{|-----|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{13}{52} = \frac{1}{4}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{4}{52} = \frac{1}{13}$}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{1}{52}=\pr{E}\pr{F}$}}
	&\multicolumn{1}{p{\gnumericColE}|}%
...
\hhline{|-----|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{26}{52} = \frac{1}{2}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{4}{52} = \frac{1}{13}$}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{2}{52}=\frac{1}{26}=\pr{E}\pr{F}$}}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\centering}\gnumbox{Yes}}
	&
\\
\hhline{|-----|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{8}{52} = \frac{2}{13}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{8}{52} = \frac{2}{13}$}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\centering}\gnumbox{$\frac{4}{52}=\frac{1}{13}\ne\pr{E}\pr{F}$}}
