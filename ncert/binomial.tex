...
\solution
 \input{ncert/11/16/3/8/binom.tex}
	\item 
	A game consists of tossing a one rupee coin 3 times and noting its outcome each time. Hans wins if all the tosses give the same result i.e., three heads or three tails, and loses otherwise. Calculate the probability that Hans will lose the game.
\\
 \input{ncert/10/15/1/23/main.tex}
\item A coin is tossed three times. Determine \pr{E|F} where
\begin{enumerate}
...
\end{enumerate}
\solution 
 \input{ncert/12/13/1/6/main.tex}
...
\\
\solution  \input{ncert/12/13/6/10/binom.tex}
...
\\
\solution
 \input{ncert/11/16/3/7a/main.tex}
...
\end{enumerate}
\solution
% \input{ncert/12/13/1/12/binom.tex}
