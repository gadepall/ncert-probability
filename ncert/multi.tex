...
\item A bag contain 5 red and 3 blue balls. If 3 balls are drawn at random without replacement, the probability of getting exactly one red ball is
	\begin{multicols}{4}
\begin{enumerate}
...
\end{multicols}
\solution
\input{exemplar/12/13/3/74/main.tex}
